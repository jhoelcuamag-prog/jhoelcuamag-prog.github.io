...
$stmt = $pdo->prepare("
    SELECT t.*, p.product_name, p.product_code, p.category 
    FROM transactions t
...
");
$summary->execute([$_SESSION['user_id'], $start_date, $end_date]);
$stats = $summary->fetch();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>My Reports - Lombriks (Staff)</title>
...
<body>
    ...
    <div class="main-content fade-in">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-chart-bar text-primary"></i> My Transaction Reports</h2>
            <div class="no-print">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-muted mt-4 text-center">
                    <small>* This is an official report generated by Lombriks Inventory System</small>
                </div>
            </div>
        </div>
    </div>
